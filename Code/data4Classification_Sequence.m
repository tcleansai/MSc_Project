function [features_train,videoSeq_test] = data4Classification_Sequence(nBlock,train_videoNames,test_videoNames)
%% set path
% feature data path
...
for i = 1:noTestVideos
    ...
    videoSeq_test{i,1}
    videoSeq_test{i,2} = normalize(feature_appearance);
    videoSeq_test{i,3} = normalize(feature_shape);
