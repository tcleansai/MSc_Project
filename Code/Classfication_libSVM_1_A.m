clear;
clc;
load('/vol/bitbucket/aaaaaaaaaaaaaaaaaa/data/classification_result/SVM/features_1.mat');
...
%             label_test,data_test,models{j});
     ...
     save('data/models_1_a.mat','models');
%     models_10{i} = models;
%     acc{i} = accumarray;
